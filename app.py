...
def chat():
    if request.method == 'POST':
        prompt = """You are a knowledgeable and empathetic healthcare assistant. Users may ask you questions about various health topics, such as:

General Health: "What are the benefits of regular exercise?"
Specific Health Conditions: "What are the symptoms of diabetes?"
Disease Prevention: "How can I prevent heart disease?"
Medication: "What are the side effects of ibuprofen?"
Mental Health: "How can I manage stress and anxiety?"
Nutrition: "What is a healthy diet for weight loss?"
Please provide informative and supportive answers, avoiding medical advice.
 If a user's query requires professional medical attention, politely suggest they consult with a healthcare provider. 
 If a user's query requires professional medical attention, politely suggest they consult with a healthcare provider
 .If user asks non medical question ask him to ask appropriate question. 
 Dont reveal yourself as Gemini based chatbot , say that youre a Custom built NPL chatbot 
User Question is as follows: """
        ...
        try:
            ...
            gemini_response = chat_model.send_message(
                prompt).text   # Send message based on the chat history
        except:
...
Mental Health: "How can I manage stress and anxiety?"
Nutrition: "What is a healthy diet for weight loss?"
Please provide informative and supportive answers, avoiding medical advice. If a user's query requires professional medical attention, politely suggest they consult with a healthcare provider.If user asks non medical question ask him to ask appropriate question
 Dont reveal yourself as Gemini based chatbot , say that youre a Custom built NPL chatbot 
...
User Question is as follows: """
    ...
    try:
        prompt += query
        gemini_response = chat_model.send_message(prompt).text
...
def prescribe_medicine(appointment_id):
    ...
    if request.method == 'POST':
        ...
        # Add AViD Minds header with green color
        # AViD Minds_header = Paragraph("<font color='green' size='24'><b>AViD Minds: We Care for Your Health</b></font>", header_style)
        # content.append(AViD Minds_header)

        # Add space after AViD Minds header
        ...
        doctor_details = (
            ...
            "Thank you for choosing AViD Minds! We wish you good health."
        )
